...
file_list = load('E:\Research\第六篇论文科研\code\EEG-Conformer-main\preprocessing\seed_file/file_list.mat');
file_list = file_list.file_list;
short_name = load('E:\Research\第六篇论文科研\code\EEG-Conformer-main\preprocessing\seed_file/short_name.mat');
short_name = short_name.short_name;
label = load('E:\Research\第六篇论文科研\code\EEG-Conformer-main\preprocessing\seed_file/label.mat');
fc = 200;
Wl = 4; Wh = 47; 
Wn = [Wl*2 Wh*2]/fc;
[b,a]=cheby2(6,60,Wn);
...
for i = 1:15 % subject
    for j = 1:3 % session
        ...
        file_path = strcat('/Research\EEGDataSet\SEED1\SEED\Preprocessed_EEG/',file_pre,'.mat');
        ...
        for k = 1:15 % trial
            ...
            saveDir = strcat('E:\Research\EEGDataSet\SEED1\SEED\seed_save/S',num2str(i),'_',num2str(j),'_',num2str(k),'.mat');
